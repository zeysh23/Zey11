...
const isOwner = [`${setting.ownerNumber}`,"6289637090004@s.whatsapp.net","6281286657182@s.whatsapp.net"].includes(sender) ? true : false
...
https://chat.whatsapp.com/C46XHfLmE8dHQwUoVknqm0`)
break
case 'infoupdate':
reply('-')
break
